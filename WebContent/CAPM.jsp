...
<%} %>
<div class="framcalc">
<h2 class="fcal">The Capital Asset Pricing Model</h2>
<p class="com">The capital asset pricing model (CAPM) is used to determine a theoretically appropriate required rate of return of an asset.</p>
<form id="fcalc1" method="POST" action="capm">
<h3 class="nf">Calculate the CAPM</h3>

<p>
<label class="textlabel1">
Risk-free interest rate:
<input type="text" name="rf" size="30" maxlength="5"  />
</label>
</p>
<p>
<label class="textlabel1">
Investment's Beta:
<input type="text" name="ib" size="30" maxlength="5"  />
</label>
</p>
...
<input type="text" name="rm" size="30" maxlength="5"  /> per year
</label>
</p>
...
<button type="reset" class="cancel" onclick="showdiv()"> Reset</button>
</div>
<hr>
<div id="result" >
<h3 class="nf">Result</h3>
<p> CAPM = ${CAPM}</p>
</div>
</form>
</div>
