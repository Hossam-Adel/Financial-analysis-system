...
<div id="sih"><h2 class="ell"> Sign Up for an freelancing account</h2></div>
<form method="post" action="createflaccount">
<fieldset>
<legend>
SIGN UP
</legend>
...
<label class="textlabel">
Email address: 
<input type="email" name="mail" size="30" maxlength="100" required/>
</label>
</p>
<p>
<label class="textlabel">
Password:
<input type="password"  name="pass" placeholder="Password" id="password" size="30"  required />
</label>
</p>
<p>
<label class="textlabel">
Confirm:
<input type="password" placeholder="Confirm Password" size="30" id="confirm_password" required>
</label>
</p>
<p style="clear:both">
<label>
You are a/an: <br>
<input type="checkbox" name="type" value="investor" checked="checked"/> FINANCIAL advisor 
<input type="checkbox" name="type" value="Student" />FINANCIAL ANALYST
<input type="checkbox" name="type" value="beginner"/>BUSINESS ANALYST
<input type="checkbox" name="type" value="not specify"/>Not specify
</label>
</p>
<p>
<label>
...
<div id="submit">
<a href="freelanc account.html"> <input type="submit" value="Submit" onclick="return Validate()" > </a>
</div>
</fieldset>
</form>
</article>
