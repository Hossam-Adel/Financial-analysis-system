...
<%String stock =(String)request.getAttribute("json");%>
</style>
<script>
...
for (i = 0; i < dt.length; i++) {
	 ...
	 row.push(dtrow.industry,dtrow.number );
...
<%ArrayList<Firm> al = (ArrayList<Firm>)request.getAttribute("arrays");
...
<Script> industry = industry+1;</Script>
...
<div id="chart_div" style="width: 500x; height:400px;"></div>
