...
<form id="fcalc1" method="POST" action="forgotpass">

<p class="com">Please enter your email in the form below to help you recover you account</p>
<p>
...
<p> ${message}</p>
<div id="submit1">
<button type="submit" class="calcul" >send</button>
