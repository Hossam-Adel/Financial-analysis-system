...
<div class="framcalc">
<h2 class="fcal">Login</h2>
<form id="fcalc1" method="POST" action="login">
<h3 class="nf">Please enter valid info</h3>
...
<label class="textlabel1">
Password :
<input type="password" name="pwd" size="30" maxlength="5"  />
</label>
</p>
...
<div id="submit1">
<button type="submit" class="calcul" >login</button>
