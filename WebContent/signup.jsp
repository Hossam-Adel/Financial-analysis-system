...
<%} %>
<div id="sih"><h2 class="ell"> Sign Up for an account</h2></div>
...
<label class="textlabel">
Password:
<input type="password" placeholder="Password" id="password" name="pass"size="30"  required />
</label>
</p>
<p>
<label class="textlabel">
Confirm:
<input type="password" placeholder="check-Password" size="30" name="pass2" required>
</label>
</p>
...
<label>
You are a/an: <br>
<input type="checkbox" name="type" value="investor" checked="checked"/>investor
<input type="checkbox" name="type" value="Student" />Student
<input type="checkbox" name="type" value="beginner"/>Beginner
...
<div id="submit">
<input type="submit" value="Submit" onclick="matchpass()" id="submit2" >
</div>
</fieldset>
</form>
