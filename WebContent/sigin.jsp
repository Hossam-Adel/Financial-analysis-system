...
<body>
 <div class="dropdown">
  <button onclick="myFunction()" class="dropbtn"><img margin-top="50" src="r.png"></button>
  <div id="myDropdown" class="dropdown-content">
  <a>
    <form id="login-form" method="POST" action="login" accept-charset="UTF-8" data-validate="parsley">
	<p class="hf"> PLEASE SIGN IN </p>
     <input class="tex" type="text" id="uid"  name="uid" size="30" placeholder="EMAIL" data-type="email">
     <input class="tex" type="password" id="pwd" name="pwd" size="30" placeholder="PASSWORD" >
                            
     <div id="cb"><label class="checkbox">
     <input type="checkbox" name="remember" value="1">Remember Me</label></div>
								<br>

	<div id="forg"><a href="forgotpass.jsp">Forgot Password?</a></div>
                        
                   
                    <button id="login-submit-btn" type="submit" name="submit" >Log in</button>
					<p class="ii">  or <a href="signup.jsp"> SIGN UP FOR AN ACCOUNT </a> </p>
                </form>
    </a>
  </div>
</div>
