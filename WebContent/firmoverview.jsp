...
<button id='add' >add to watchist</button>
<button id="remove"> remove from watchlist</button>
<script>
var a='<%=user.getId()%>';
...
<%Firm f = (Firm)request.getAttribute("firm");
      ...
      %>
      <%session.setAttribute("firmcount",f.getId());%>
...
<div class="chartt" id="chartt"  style="width:500; margin-left:50;height:226;"></div>
<div class="aboutt">
<span style="color:black"><h3>About The Company</h3></span>
<%=f.getIntro() %>
</div>

<div class="overall" id="overall">
<table class="overa">
<p style="color:#00898e">Overall</p>
<tr>
<td>Beta</td>
...
<tr>
<td>Market Cap</td>
<td align="center"><%=f.getStock().getNumberofshares() * f.getStock().getClose() %></td>
</tr>
<tr>
<td>Shares Outstanding</td>
<td align="center" ><%= f.getStock().getNumberofshares() %></td>
</tr>
<tr>
<td>Dividend</td>
<td align="center" ><%=f.getDividends() %></td>
</tr>
</table>
...
<tr>
<td><b>EPS</b></td>
<td align="center"><%=eqn.earning_per_share(f.getIncstat(), f.getStock()) %></td>
<td align="center" >--</td>
</tr>
</table>
</div>
