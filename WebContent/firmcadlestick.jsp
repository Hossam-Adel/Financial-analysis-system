...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
	  ...
	  for (i = 0; i < dt.length; i++) {
		 ...
		 row.push(dtrow.day,dtrow.low,dtrow.open,dtrow.close,dtrow.high );
  ...
  function drawChart() {
    ...
    var chart = new google.visualization.CandlestickChart(document.getElementById('chartt'));
...
<form method="get" action="firmchart">
<div class="menusch">
Chart-Style:
...
<input name="id" style="visibility:hidden" value="<%=f.getId()%>">
</form>
